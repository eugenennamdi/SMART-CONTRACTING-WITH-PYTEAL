...
function mkTransaction(execParams, suggestedParams) {
    ...
    switch (execParams.type) {
        case types_1.TransactionType.TransferAsset: {
            const tx = algosdk_1.default.makeAssetTransferTxnWithSuggestedParams(fromAccountAddr, execParams.toAccountAddr, execParams.payFlags.closeRemainderTo, undefined, execParams.amount, note, execParams.assetID, suggestedParams);
            return updateTxFee(execParams.payFlags, tx);
        }
        case types_1.TransactionType.ModifyAsset: {
            const tx = algosdk_1.default.makeAssetConfigTxnWithSuggestedParams(fromAccountAddr, encodeNote(execParams.payFlags.note, execParams.payFlags.noteb64), execParams.assetID, execParams.fields.manager !== "" ? execParams.fields.manager : undefined, execParams.fields.reserve !== "" ? execParams.fields.reserve : undefined, execParams.fields.freeze !== "" ? execParams.fields.freeze : undefined, execParams.fields.clawback !== "" ? execParams.fields.clawback : undefined, suggestedParams, false);
            return updateTxFee(execParams.payFlags, tx);
        }
        case types_1.TransactionType.FreezeAsset: {
            const tx = algosdk_1.default.makeAssetFreezeTxnWithSuggestedParams(fromAccountAddr, encodeNote(execParams.payFlags.note, execParams.payFlags.noteb64), execParams.assetID, execParams.freezeTarget, execParams.freezeState, suggestedParams);
            return updateTxFee(execParams.payFlags, tx);
        }
        case types_1.TransactionType.RevokeAsset: {
            const tx = algosdk_1.default.makeAssetTransferTxnWithSuggestedParams(fromAccountAddr, execParams.recipient, execParams.payFlags.closeRemainderTo, execParams.revocationTarget, execParams.amount, encodeNote(execParams.payFlags.note, execParams.payFlags.noteb64), execParams.assetID, suggestedParams);
            return updateTxFee(execParams.payFlags, tx);
        }
        case types_1.TransactionType.DestroyAsset: {
            const tx = algosdk_1.default.makeAssetDestroyTxnWithSuggestedParams(fromAccountAddr, encodeNote(execParams.payFlags.note, execParams.payFlags.noteb64), execParams.assetID, suggestedParams);
            return updateTxFee(execParams.payFlags, tx);
        }
        ...
        case types_1.TransactionType.OptInASA: {
            const tx = algosdk_1.default.makeAssetTransferTxnWithSuggestedParams(fromAccountAddr, fromAccountAddr, undefined, undefined, 0, note, execParams.assetID, suggestedParams);
            return updateTxFee(execParams.payFlags, tx);
        }
        default: {
